<?php
    $lpl = query("SELECT COUNT(no_registrasi) FROM lapor_lahir WHERE status='rs_puskesmas'")[0]["COUNT(no_registrasi)"];
    $lpm = query("SELECT COUNT(no_registrasi) FROM lapor_mati WHERE status='rs_puskesmas'")[0]["COUNT(no_registrasi)"];
?>
<div>
