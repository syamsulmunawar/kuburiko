$(function(){
    ...
    $("#nik_simati_error").hide();
    var error_nik_simati = false;
    $("#nama_simati_error").hide();
    var error_nama_simati = false;
    $("#tempat_lahir_simati_error").hide();
    var error_tempat_lahir_simati = false;
    $("#tll_simati_error").hide();
    var error_tll_simati = false;
    $("#pekerjaan_simati_error").hide();
    var error_pekerjaan_simati = false;
    $("#desa_kelurahan_simati_error").hide();
    var error_desa_kelurahan_simati = false;
    $("#kecamatan_simati_error").hide();
    var error_kecamatan_simati = false;
    $("#kabupaten_simati_error").hide();
    var error_kabupaten_simati = false;
    $("#provinsi_simati_error").hide();
    var error_provinsi_simati = false;
    $("#meninggal_di_error").hide();
    var error_meninggal_di = false;
    $("#tgl_meninggal_error").hide();
    var error_tgl_meninggal = false;
    $("#pukul_error").hide();
    var error_pukul = false;
    $("#penyebab_kematian_error").hide();
    var error_penyebab_kematian = false;
    $("#bukti_kematian_error").hide();
    var error_bukti_kematian = false;
    $("#nik_pelapor_error").hide();
    var error_nik_pelapor = false;
    $("#nama_pelapor_error").hide();
    var error_nama_pelapor = false;
    $("#tl_pelapor_error").hide();
    var error_tl_pelapor = false;
    $("#tll_pelapor_error").hide();
    var error_tll_pelapor = false;
    $("#umur_pelapor_error").hide();
    var error_umur_pelapor = false;
    $("#pekerjaan_pelapor_error").hide();
    var error_pekerjaan_pelapor = false;
    $("#pertalian_error").hide();
    var error_pertalian = false;
    $("#desa_kelurahan_pelapor_error").hide();
    var error_desa_kelurahan_pelapor = false;
    $("#kecamatan_pelapor_error").hide();
    var error_kecamatan_pelapor = false;
    $("#kabupaten_pelapor_error").hide();
    var error_kabupaten_pelapor = false;
    $("#provinsi_pelapor_error").hide();
    var error_provinsi_pelapor = false;
    ...
    function cek_nomor_kk(){
        ...
        if(nomor_kk == 0){
            $("#nomor_kk_error").html("Nomor KK Harus Diisi");
            $("#nomor_kk_error").show();
            error_nomor_kk = true;
    ...
    $("#nik_simati").focusout(function(){
        cek_nik_simati();
    });
    function cek_nik_simati(){
        var nik_simati = $("#nik_simati").val().length;
        if(nik_simati == 0){
            $("#nik_simati_error").html("Kolom Ini Harus Diisi");
            $("#nik_simati_error").show();
            error_nik_simati = true;
        }else if(nik_simati !== 0 && nik_simati !== 16){
            $("#nik_simati_error").html("Kolom Ini Harus Berisi 16 Karakter");
            $("#nik_simati_error").show();
            error_nik_simati = true;
        }else{
            $("#nik_simati_error").hide();
    ...
    $("#nama_simati").focusout(function(){
        cek_nama_simati();
    });
    function cek_nama_simati(){
        var nama_simati = $("#nama_simati").val().length;
        if(nama_simati == 0){
            $("#nama_simati_error").html("Kolom Ini Harus Diisi");
            $("#nama_simati_error").show();
            error_nama_simati = true;
        }else{
            $("#nama_simati_error").hide();
        }
    }
    $("#tempat_lahir_simati").focusout(function(){
        cek_tempat_lahir_simati();
    });
    function cek_tempat_lahir_simati(){
        var tempat_lahir_simati = $("#tempat_lahir_simati").val().length;
        if(tempat_lahir_simati == 0){
            $("#tempat_lahir_simati_error").html("Kolom Ini Harus Diisi");
            $("#tempat_lahir_simati_error").show();
            error_tempat_lahir_simati = true;
        }else{
            $("#tempat_lahir_simati_error").hide();
        }
    }
    $("#tll_simati").focusout(function(){
        cek_tll_simati();
    });
    function cek_tll_simati(){
        var tll_simati = $("#tll_simati").val().length;
        if(tll_simati == 0){
            $("#tll_simati_error").html("Kolom Ini Harus Diisi");
            $("#tll_simati_error").show();
            error_tll_simati = true;
        }else{
            $("#tll_simati_error").hide();
        }
    }
    $("#pekerjaan_simati").focusout(function(){
        cek_pekerjaan_simati();
    });
    function cek_pekerjaan_simati(){
        var pekerjaan_simati = $("#pekerjaan_simati").val().length;
        if(pekerjaan_simati == 0){
            $("#pekerjaan_simati_error").html("Kolom Ini Harus Diisi");
            $("#pekerjaan_simati_error").show();
            error_pekerjaan_simati = true;
        }else{
            $("#pekerjaan_simati_error").hide();
        }
    }
    $("#desa_kelurahan_simati").focusout(function(){
        cek_desa_kelurahan_simati();
    });
    function cek_desa_kelurahan_simati(){
        var desa_kelurahan_simati = $("#desa_kelurahan_simati").val().length;
        if(desa_kelurahan_simati == 0){
            $("#desa_kelurahan_simati_error").html("Kolom Ini Harus Diisi");
            $("#desa_kelurahan_simati_error").show();
            error_desa_kelurahan_simati = true;
        }else{
            $("#desa_kelurahan_simati_error").hide();
        }
    }
    $("#kecamatan_simati").focusout(function(){
        cek_kecamatan_simati();
    });
    function cek_kecamatan_simati(){
        var kecamatan_simati = $("#kecamatan_simati").val().length;
        if(kecamatan_simati == 0){
            $("#kecamatan_simati_error").html("Kolom Ini Harus Diisi");
            $("#kecamatan_simati_error").show();
            error_kecamatan_simati = true;
        }else{
            $("#kecamatan_simati_error").hide();
        }
    }
    $("#kabupaten_simati").focusout(function(){
        cek_kabupaten_simati();
    });
    function cek_kabupaten_simati(){
        var kabupaten_simati = $("#kabupaten_simati").val().length;
        if(kabupaten_simati == 0){
            $("#kabupaten_simati_error").html("Kolom Ini Harus Diisi");
            $("#kabupaten_simati_error").show();
            error_kabupaten_simati = true;
        }else{
            $("#kabupaten_simati_error").hide();
        }
    }
    $("#provinsi_simati").focusout(function(){
        cek_provinsi_simati();
    });
    function cek_provinsi_simati(){
        var provinsi_simati = $("#provinsi_simati").val().length;
        if(provinsi_simati == 0){
            $("#provinsi_simati_error").html("Kolom Ini Harus Diisi");
            $("#provinsi_simati_error").show();
            error_provinsi_simati = true;
        }else{
            $("#provinsi_simati_error").hide();
        }
    }
    $("#meninggal_di").focusout(function(){
        cek_meninggal_di();
    });
    function cek_meninggal_di(){
        var meninggal_di = $("#meninggal_di").val().length;
        if(meninggal_di == 0){
            $("#meninggal_di_error").html("Kolom Ini Harus Diisi");
            $("#meninggal_di_error").show();
            error_meninggal_di = true;
        }else{
            $("#meninggal_di_error").hide();
        }
    }
    $("#tgl_meninggal").focusout(function(){
        cek_tgl_meninggal();
    });
    function cek_tgl_meninggal(){
        var tgl_meninggal = $("#tgl_meninggal").val().length;
        if(tgl_meninggal == 0){
            $("#tgl_meninggal_error").html("Kolom Ini Harus Diisi");
            $("#tgl_meninggal_error").show();
            error_tgl_meninggal = true;
        }else{
            $("#tgl_meninggal_error").hide();
        }
    }
    ...
    $("#penyebab_kematian").focusout(function(){
        cek_penyebab_kematian();
    });
    function cek_penyebab_kematian(){
        var penyebab_kematian = $("#penyebab_kematian").val().length;
        if(penyebab_kematian == 0){
            $("#penyebab_kematian_error").html("Kolom Ini Harus Diisi");
            $("#penyebab_kematian_error").show();
            error_penyebab_kematian = true;
        }else{
            $("#penyebab_kematian_error").hide();
        }
    }
    $("#bukti_kematian").focusout(function(){
        cek_bukti_kematian();
    });
    function cek_bukti_kematian(){
        var bukti_kematian = $("#bukti_kematian").val().length;
        if(bukti_kematian == 0){
            $("#bukti_kematian_error").html("Kolom Ini Harus Diisi");
            $("#bukti_kematian_error").show();
            error_bukti_kematian = true;
        }else{
            $("#bukti_kematian_error").hide();
        }
    }
    $("#nik_pelapor").focusout(function(){
        cek_nik_pelapor();
    });
    function cek_nik_pelapor(){
        var nik_pelapor = $("#nik_pelapor").val().length;
        if(nik_pelapor == 0){
            $("#nik_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#nik_pelapor_error").show();
            error_nik_pelapor = true;
        }else if(nik_pelapor !== 0 && nik_pelapor !== 16){
            $("#nik_pelapor_error").html("NIK Harus Berisi 16 Karakter");
            $("#nik_pelapor_error").show();
            error_nik_pelapor = true;
        }else{
            $("#nik_pelapor_error").hide();
    ...
    $("#nama_pelapor").focusout(function(){
        cek_nama_pelapor();
    });
    function cek_nama_pelapor(){
        var nama_pelapor = $("#nama_pelapor").val().length;
        if(nama_pelapor == 0){
            $("#nama_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#nama_pelapor_error").show();
            error_nama_pelapor = true;
        }else{
            $("#nama_pelapor_error").hide();
        }
    }
    $("#tl_pelapor").focusout(function(){
        cek_tl_pelapor();
    });
    function cek_tl_pelapor(){
        var tl_pelapor = $("#tl_pelapor").val().length;
        if(tl_pelapor == 0){
            $("#tl_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#tl_pelapor_error").show();
            error_tl_pelapor = true;
        }else{
            $("#tl_pelapor_error").hide();
        }
    }
    $("#tll_pelapor").focusout(function(){
        cek_tll_pelapor();
    });
    function cek_tll_pelapor(){
        var tll_pelapor = $("#tll_pelapor").val().length;
        if(tll_pelapor == 0){
            $("#tll_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#tll_pelapor_error").show();
            error_tll_pelapor = true;
        }else{
            $("#tll_pelapor_error").hide();
        }
    }
    $("#umur_pelapor").focusout(function(){
        cek_umur_pelapor();
    });
    function cek_umur_pelapor(){
        var umur_pelapor = $("#umur_pelapor").val().length;
        if(umur_pelapor == 0){
            $("#umur_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#umur_pelapor_error").show();
            error_umur_pelapor = true;
        }else{
            $("#umur_pelapor_error").hide();
        }
    }
    $("#pekerjaan_pelapor").focusout(function(){
        cek_pekerjaan_pelapor();
    });
    function cek_pekerjaan_pelapor(){
        var pekerjaan_pelapor = $("#pekerjaan_pelapor").val().length;
        if(pekerjaan_pelapor == 0){
            $("#pekerjaan_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#pekerjaan_pelapor_error").show();
            error_pekerjaan_pelapor = true;
        }else{
            $("#pekerjaan_pelapor_error").hide();
        }
    }
    $("#pertalian").focusout(function(){
        cek_pertalian();
    });
    function cek_pertalian(){
        var pertalian = $("#pertalian").val().length;
        if(pertalian == 0){
            $("#pertalian_error").html("Kolom Ini Harus Diisi");
            $("#pertalian_error").show();
            error_pertalian = true;
        }else{
            $("#pertalian_error").hide();
        }
    }
    $("#desa_kelurahan_pelapor").focusout(function(){
        cek_desa_kelurahan_pelapor();
    });
    function cek_desa_kelurahan_pelapor(){
        var desa_kelurahan_pelapor = $("#desa_kelurahan_pelapor").val().length;
        if(desa_kelurahan_pelapor == 0){
            $("#desa_kelurahan_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#desa_kelurahan_pelapor_error").show();
            error_desa_kelurahan_pelapor = true;
        }else{
            $("#desa_kelurahan_pelapor_error").hide();
        }
    }
    $("#kecamatan_pelapor").focusout(function(){
        cek_kecamatan_pelapor();
    });
    function cek_kecamatan_pelapor(){
        var kecamatan_pelapor = $("#kecamatan_pelapor").val().length;
        if(kecamatan_pelapor == 0){
            $("#kecamatan_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#kecamatan_pelapor_error").show();
            error_kecamatan_pelapor = true;
        }else{
            $("#kecamatan_pelapor_error").hide();
        }
    }
    $("#kabupaten_pelapor").focusout(function(){
        cek_kabupaten_pelapor();
    });
    function cek_kabupaten_pelapor(){
        var kabupaten_pelapor = $("#kabupaten_pelapor").val().length;
        if(kabupaten_pelapor == 0){
            $("#kabupaten_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#kabupaten_pelapor_error").show();
            error_kabupaten_pelapor = true;
        }else{
            $("#kabupaten_pelapor_error").hide();
        }
    }
    $("#provinsi_pelapor").focusout(function(){
        cek_provinsi_pelapor();
    });
    function cek_provinsi_pelapor(){
        var provinsi_pelapor = $("#provinsi_pelapor").val().length;
        if(provinsi_pelapor == 0){
            $("#provinsi_pelapor_error").html("Kolom Ini Harus Diisi");
            $("#provinsi_pelapor_error").show();
            error_provinsi_pelapor = true;
        }else{
            $("#provinsi_pelapor_error").hide();
        }
    }
    ...
    var tab2 = document.getElementById("simati_pelapor");
    ...
    $("#next").click(function(){
        ...
        error_nik_simati = false;
        error_nama_simati = false;
        error_tempat_lahir_simati = false;
        error_tll_simati = false;
        error_pekerjaan_simati = false;
        error_desa_kelurahan_simati = false;
        error_kecamatan_simati = false;
        error_kabupaten_simati = false;
        error_provinsi_simati = false;
        error_meninggal_di = false;
        error_tgl_meninggal = false;
        error_pukul = false;
        error_penyebab_kematian = false;
        error_bukti_kematian = false;
        error_nik_pelapor = false;
        error_nama_pelapor = false;
        error_tl_pelapor = false;
        error_tll_pelapor = false;
        error_umur_pelapor = false;
        error_pekerjaan_pelapor = false;
        error_pertalian = false;
        error_desa_kelurahan_pelapor = false;
        error_kecamatan_pelapor = false;
        error_kabupaten_pelapor = false;
        error_provinsi_pelapor = false;
    ...
    if(tab==1){
        if($("#jumlah_anak").val() == 0){
            ...
            if(error_nik_simati || error_nama_simati || error_tempat_lahir_simati || error_tll_simati || error_pekerjaan_simati || error_desa_kelurahan_simati || error_kecamatan_simati
                 || error_kabupaten_simati || error_provinsi_simati || error_meninggal_di || error_tgl_meninggal || error_pukul || error_penyebab_kematian
                 || error_bukti_kematian || error_nik_pelapor || error_nama_pelapor || error_tl_pelapor || error_tll_pelapor || error_umur_pelapor || error_pekerjaan_pelapor
                 || error_pertalian || error_desa_kelurahan_pelapor || error_kecamatan_pelapor || error_kabupaten_pelapor || error_provinsi_pelapor){
